...
public class Constants {
  ...
  public static int wristDownSetPoint = -42600;//0 ticks
  public static int wristMidSetPoint = (28*((4096/360)*(45))); //14,336 ticks
  public static int wristUpSetPoint = -15500; 
  public static final double defaultWristPosition = -5000;
  public static final double[] wristPIDValues = {.25, 0, 0, 0};
  public static final double wristShootSetPoint = -18100;
